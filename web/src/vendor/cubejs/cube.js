// VENDORED from cubejs 1.3.2 (lib/cube.js), 2026-09-22. See ./README.md.
//
// Upstream, byte for byte, except: the UMD globals block at the end became an
// ESM export, and the outer IIFE is called with `undefined` instead of `this`
// (in a module `this` is undefined anyway; nothing in the body reads it - every
// `this.` here is an instance inside a method). Do not edit anything else:
// test/vendor-cubejs.test.ts checks this copy against the npm package, which
// stays a devDependency so the suite keeps an independent oracle.
...
(function() {
  ...
  // (vendored: was a UMD globals block - `module.exports = Cube` or `this.Cube = Cube`.
  // ESM has neither, so the class goes to the module-scope binding declared above.)
  exported = Cube;
