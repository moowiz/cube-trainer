// VENDORED from cubejs 1.3.2 (lib/solve.js), 2026-09-22. See ./README.md.
//
// Kociemba's two-phase solver. Upstream, byte for byte, except: it picked the
// class up from the global or a CommonJS require, and now takes it from the
// ESM import; the outer IIFE is called with `undefined` for the same reason as
// cube.js. Importing this module adds initSolver/solve/random/inverse/scramble
// to the class - it exports nothing itself.

import VendoredCube from './cube.js';
...
(function() {
  ...
  Cube = VendoredCube; // (vendored: was `this.Cube || require('./cube')`)
