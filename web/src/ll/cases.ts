...
export const PLL_CASES: LLCase[] = [
  ...
  { id: 'Ua', name: 'Ua', alg: 'M2 U M U2 M\' U M2', hint: 'a bar of three and headlights on the other three sides, the edges cycling counter-clockwise seen from above: face the bar, the edge on your left belongs on your right', alts: [{ alg: "R U' R U R U R U' R' U' R2", note: 'R and U only: R U\' R U R U R U\' R\' U\' R2' }, { alg: "F2 U' L R' F2 L' R U' F2", note: 'a sandwich: F2 U\', both hands (L R\'), F2, both hands back (L\' R), U\' F2' }] },
  { id: 'Ub', name: 'Ub', alg: "M2 U' M U2 M' U' M2", hint: 'a bar of three and headlights on the other three sides, the edges cycling clockwise seen from above: face the bar, the edge on your right belongs on your left', alts: [{ alg: "R2 U R U R' U' R' U' R' U R'", note: 'R and U only: R2 U R U R\' U\' R\' U\' R\' U R\'' }, { alg: "F2 U L R' F2 L' R U F2", note: 'a sandwich: F2 U, both hands (L R\'), F2, both hands back (L\' R), U F2' }] },
